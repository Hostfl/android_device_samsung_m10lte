...
# Assert
TARGET_OTA_ASSERT_DEVICE := m10lte
...
#BOARD_RECOVERYIMAGE_PARTITION_SIZE := 25676320 # This is the maximum known partition size, but it can be higher, so we just omit it
